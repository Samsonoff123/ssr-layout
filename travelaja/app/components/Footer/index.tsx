    ...
    <footer className={styles.footer}>
        <div className="container">
            <div className={styles.footer__main}>
                ...
                <div className={styles.footer__main__element}>
                    <h3>links</h3>
                    <Link href="/discover" className={styles.footer__main__element__text}>
                        Discover
                    </Link>
                    <Link href="/specials" className={styles.footer__main__element__text}>
                        Special Deals
                    </Link>
                    <Link href="/services" className={styles.footer__main__element__text}>
                        Services
                    </Link>
                    <Link href="/community" className={styles.footer__main__element__text}>
                        Community
                    </Link>
                    <Link href="/about" className={styles.footer__main__element__text}>
                        About Us
                    </Link>
                </div>
                <div className={styles.footer__main__element}>
                    ...
                    <Link href="/Term and Condition" className={styles.footer__main__element__text}>
                        Term and Condition
                    </Link>
                    <Link href="/Privacy Policy" className={styles.footer__main__element__text}>
                        Privacy Policy
                    </Link>
                    <Link href="/contact" className={styles.footer__main__element__text}>
                        Contact Us
                    </Link>
                </div>
                <div className={styles.footer__main__element}>
                    <h3>Contact</h3>
                    <span className={styles.footer__main__element__text}>
